...
import BlogPage, { loader as fetchPosts } from "./pages/BlogPage";
import BmiPage from "./pages/BmiPage";
import BmrPage from "./pages/BmrPage";
import ExercisesPage, { loader as fetchExercises } from "./pages/ExercisesPage";
...
import LoginPage, { action as loginUser } from "./pages/LoginPage";
import AddPostPage, { action as addPost } from "./pages/AddPostPage";
import PostDetailsPage, {
  loader as fetchPost,
  action as removePost,
} from "./pages/PostDetailsPage";
import EditPostPage, { action as updatePost } from "./pages/EditPostPage";
